...
const LQAA = {
    ...
    async submitForm() {
        ...
        try {
            ...
            this.showFormMessage('success', 'Thank you! Your enquiry has been sent successfully. We\'ll respond within 2 hours.');
            this.elements.form.reset();
            
        } catch (error) {
            console.error('Form submission error:', error);
            this.showFormMessage('error', 'Sorry, there was an error sending your message. Please try again or call us directly.');
        } finally {
            // Restore button
